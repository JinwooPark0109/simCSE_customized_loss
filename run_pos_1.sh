...
number=19984
#for loss in original_reshape_loss original_reshape_detached_loss zero_mean_zero_std_add_pos_loss zero_mean_zero_std_add_pos_detached_loss
for loss in zero_mean_z_std_add_pos_loss zero_mean_z_std_add_pos_detached_loss
