...
number=19984
#for loss in bernoulli_pos_loss bernoulli_pos_detached_loss fgsm_1_1_pos_loss fgsm_01_1_pos_loss
for loss in  fgsm_1_1_pos_loss
#for loss in  fgsm_01_1_pos_loss
do
